...
class SpeakingTest(db.Model):
    ...
    for i in range(1, 11):
        ...
        locals()[f'thinking{i}_part2'] = db.Column(db.Integer, nullable=True)
        locals()[f'speaking{i}_part2'] = db.Column(db.Integer, nullable=True)
...
class User(db.Model):
    ...
    chat_id = db.Column(db.Integer, nullable=False)
    education_center = db.Column(db.Integer, nullable=False)
    password = db.Column(db.String(100), nullable=False)
    verification = db.Column(db.Integer, nullable=False)
    payment = db.Column(db.String(1000000), nullable=False)
    created_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)
    updated_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False, onupdate=datetime.utcnow)
...
class Token(db.Model):
    ...
    aimed = db.Column(db.String(255), nullable=True)
